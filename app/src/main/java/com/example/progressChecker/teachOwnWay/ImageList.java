...
public class ImageList extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new ImageListAdapter(this, R.layout.activity_images_items, list);
        gridView.setAdapter(adapter);

        // get all data from sqlite
        Cursor cursor = TeachOwnWay.sqLiteHelper.getData("SELECT * FROM TeachOwnWay");
        list.clear();
        while (cursor.moveToNext()) {
            ...
            list.add(new Image(name, desc, image, id));
        }
        adapter.notifyDataSetChanged();


        // https://stackoverflow.com/questions/14435753/set-an-item-long-click-listener-in-gridview
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = TeachOwnWay.sqLiteHelper.getData("SELECT id FROM TeachOwnWay");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        dialog.setContentView(R.layout.activity_update_image);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    TeachOwnWay.sqLiteHelper.updateData(
                            edtName.getText().toString().trim(),
                            edtDesc.getText().toString().trim(),
                            TeachOwnWay.imageViewToByte(imageViewImage),
                            position
                    );
                    dialog.dismiss();
    ...
    private void showDialogDelete(final int idImage){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    TeachOwnWay.sqLiteHelper.deleteData(idImage);
